package preloader
{
	...
	public class CustomPreloaderClone extends Sprite
	{
		...
		public function CustomPreloaderClone()
		{
			super();
		...
		public function hideAreas():void
		{
			TweenMax.to(topRect, 1, {
				y: -stage.stageHeight/2-10
			});
			
			TweenMax.to(bottomRect, 1, {
				y: stage.stageHeight + 10 ,
				onComplete: hideAreasComplete
			});
		}
		
		protected function hideAreasComplete():void
		{
			stage.removeEventListener(Event.RESIZE, onStageResize);
			this.dispatchEvent(new Event("hideAreasComplete"));
		}
		
		public function drawFinalState():void
		{
			topLineRect.graphics.clear();
			topLineRect.graphics.beginFill(0x000000);
			topLineRect.graphics.drawRect( 0, 0, stage.stageWidth, 2);
			
			bottomLineRect.graphics.clear();
			bottomLineRect.graphics.beginFill(0x000000);
			bottomLineRect.graphics.drawRect( 0, 0, stage.stageWidth, 2);
